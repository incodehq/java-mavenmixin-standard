...
If you are using git, you might also want to configure the link:https://github.com/ktoso/maven-git-commit-id-plugin[git-commit-id-plugin] to populate the ${git.commit.id} property.
